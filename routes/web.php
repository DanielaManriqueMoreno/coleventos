...
=======
    ...
    Route::prefix('boleteria')->group(function(){
        Route::get('/index', [BoleteriaController::class, 'index'])->name('boleteria.index');
        Route::get('/create', [BoleteriaController::class, 'create'])->name('boleteria.create');
        Route::get('/edit/{id}', [BoleteriaController::class, 'edit'])->name('boleteria.edit');
        Route::post('/store', [BoleteriaController::class, 'store'])->name('boleteria.store');
        Route::put('/update/{id}', [BoleteriaController::class, 'update'])->name('boleteria.update');
        Route::get('/destroy/{id}', [BoleteriaController::class, 'destroy'])->name('boleteria.destroy');
    });
